...
#ifndef MAKEOTF_LIB_HOTCONV_CMAP_H_
#define MAKEOTF_LIB_HOTCONV_CMAP_H_
...
void cmapAddUVSEntry(hotCtx g, unsigned int uvsFlags, unsigned long uv,
                     unsigned long uvs, GID gid);
void cmapEndUVSEncoding(hotCtx g);

void cmapPointToPreviousEncoding(hotCtx g, unsigned platform,
                                 unsigned platformSpecific);

#endif  // MAKEOTF_LIB_HOTCONV_CMAP_H_
