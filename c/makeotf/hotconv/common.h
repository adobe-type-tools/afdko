...
#ifndef MAKEOTF_LIB_HOTCONV_COMMON_H_
#define MAKEOTF_LIB_HOTCONV_COMMON_H_
...
typedef struct { /* Glyph information */
    ...
    const char *srcName; /* Actual pointer to development glyph name */
    short flags;
...
#define FI_CUSTOM_CS 3         /* Custom (defined by font) */
    ...
    const char *vendId;    /* Vendor id */
    const char *licenseID; /* Font licensor ID. */
...
#endif  // MAKEOTF_LIB_HOTCONV_COMMON_H_
