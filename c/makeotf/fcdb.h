...
#ifndef MAKEOTF_SOURCE_FCDB_H_
#define MAKEOTF_SOURCE_FCDB_H_
...
struct fcdbCallbacks_ {
   ...
   validation). */
    ...
    void (*addlink)(void *ctx, int style, const char *fontname);
   ...
   PostScript FontName of the linked font. */
    ...
    void (*addenc)(void *ctx, int code, const char *gname);
