...
#endif
{
    ...
    Attrib m, n;
    zzBLOCK(zztasp1);
    PCCTS_PURIFY(_retv, sizeof(int32_t))
    zzMake0;
    {
        _retv = 0; /* Suppress optimizer warning */
        h->linenum = zzline;
                            ...
                            if ((LA(1) == K_anchordef)) {
                                ...
                                if ((LA(1) == K_valueRecordDef)) {
                                    ...
                                    if ((LA(1) == 155)) {
                                        ...
                                        zzFAIL(1, zzerr96, &zzMissSet, &zzMissText, &zzBadTok, &zzBadText, &zzErrk);
                                        goto fail;
                                    }
                                }
                            }
