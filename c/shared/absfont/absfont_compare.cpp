...
static int compareOpEntries(const abfOpEntry *opEntry1,
                            const abfOpEntry *opEntry2) {
...
static int comparePrivateDicts(const abfPrivateDict *private1,
                               const abfPrivateDict *private2) {
    int i;
