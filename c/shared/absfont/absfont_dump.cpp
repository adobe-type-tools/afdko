...
/* Dump string. */
static void dumpString(abfDumpCtx h, const char *name, const char *ptr) {
...
/* Dump integer array. */
static void dumpIntArray(abfDumpCtx h, const char *name, long cnt,
                         long *array) {
    int i;
    const char *sep;
...
/* Dump real array. */
static void dumpRealArray(abfDumpCtx h, const char *name, long cnt,
                          float *array) {
    int i;
    const char *sep;
...
/* Dump FontMatrix. */
static void dumpFontMatrix(abfDumpCtx h, const char *name,
...
static void dumpTopDict(abfDumpCtx h, abfTopDict *top) {
    const char *OrigFontType;
    const char *srcFontType;
...
static void CTL_CDECL dumpInstr(abfGlyphCallbacks *cb, const char *fmt, ...) {
    abfDumpCtx h = (abfDumpCtx)cb->direct_ctx;
    va_list ap;
    va_start(ap, fmt);
    switch (h->level) {
