...
"\n",
"Note also that the matrix argumentt list  is NOT the same thing as the font\n",
...
"details. For any coordinates 9x,y), the coordinates after applying the transform are:\n",
"x' = ax + cy + e\n",
"y' = bx + dy + f\n",
"\n",
