...
#define	DLV(l,s,v) DL(l,(OUTPUTBUFF, s "%ld.%ld (%08lx)\n",VERSION_ARG(v)))
#define	DLF(l,s,v) DL(l,(OUTPUTBUFF, s "%.3f (%08lx)\n",FIXED_ARG(v)))
#define	DLP(l,s,v) DL(l,(OUTPUTBUFF, s "{%lu,<%s>}\n",STR_ARG(v)))
#define	DLs(l,s,v) DL(l,(OUTPUTBUFF, s "%hd\n",(v)))
#define	DLu(l,s,v) DL(l,(OUTPUTBUFF, s "%hu\n",(v)))
#define	DLS(l,s,v) DL(l,(OUTPUTBUFF, s "%ld\n",(v)))
#define	DLU(l,s,v) DL(l,(OUTPUTBUFF, s "%lu\n",(v)))
#define	DLx(l,s,v) DL(l,(OUTPUTBUFF, s "%04hx\n",(v)))
#define	DLX(l,s,v) DL(l,(OUTPUTBUFF, s "%08lx\n",(v)))
...
#define	DDLV(l,s,v) DDL(l,(OUTPUTBUFF, s "%ld.%ld (%08lx)",VERSION_ARG(v)))
#define	DDLF(l,s,v) DDL(l,(OUTPUTBUFF, s "%1.3f (%08lx)",FIXED_ARG(v)))
...
#define	DDLS(l,s,v) DDL(l,(OUTPUTBUFF, s "%ld",(v)))
#define	DDLU(l,s,v) DDL(l,(OUTPUTBUFF, s "%lu",(v)))
#define	DDLx(l,s,v) DDL(l,(OUTPUTBUFF, s "%04hx",(v)))
#define	DDLX(l,s,v) DDL(l,(OUTPUTBUFF, s "%08lx",(v)))
